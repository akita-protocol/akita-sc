...
var BaseSDK = (_class = class {
  ...
  __init() {this.readerAccount = _chunkLAHRKL35js.DEFAULT_READER}
  __init2() {this.sendParams = _chunkLAHRKL35js.DEFAULT_SEND_PARAMS}
  ...
  constructor({ factoryParams, algorand, factory, readerAccount, sendParams }, envVarName) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);
    ...
    const resolvedAppId = _chunkLAHRKL35js.resolveAppIdWithClient.call(void 0, 
      algorand,
      factoryParams.appId,
...
//# sourceMappingURL=chunk-GL3BLPAF.js.map