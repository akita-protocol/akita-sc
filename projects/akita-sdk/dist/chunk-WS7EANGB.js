...
var _chunkC4OZ2LUZjs = require('./chunk-C4OZ2LUZ.js');


var _chunkPIXALTBWjs = require('./chunk-PIXALTBW.js');


var _chunkGNJHJVNXjs = require('./chunk-GNJHJVNX.js');





var _chunkUPNINHDSjs = require('./chunk-UPNINHDS.js');
...
// src/dao/legacy.ts
var LEGACY_DAO_ACTION_STRUCTS = {
  ProposalNewEscrow: [{ name: "escrow", type: "string" }]
};
function decodeLegacyProposalNewEscrow(actionData) {
  return _chunkUPNINHDSjs.decodeABIValue.call(void 0, 
    actionData,
    "ProposalNewEscrow",
    LEGACY_DAO_ACTION_STRUCTS
  );
}
function usesLegacyEscrowActionShape(proposalTimestamp, cutoverTimestamp) {
  return cutoverTimestamp !== void 0 && proposalTimestamp < cutoverTimestamp;
}
...
// src/dao/index.ts
var AkitaDaoSDK = (_class2 = class extends _chunkKLHVDYDWjs.BaseSDK {
  
  __init5() {this._wallet = null}
  __init6() {this._walletInitPromise = null}
  
  constructor(params) {
    super({ factory: _chunkGNJHJVNXjs.AkitaDaoFactory, ...params }, _chunkHFHM5QOFjs.ENV_VAR_NAMES.DAO_APP_ID);_class2.prototype.__init5.call(this);_class2.prototype.__init6.call(this);;
  ...
  async _initializeWallet() {
    ...
    this._wallet = new (0, _chunkC4OZ2LUZjs.WalletSDK)({
  ...
  async prepProposalActions(actions) {
    ...
    for (let i = 0; i < actions.length; i++) {
      ...
      switch (typedAction.type) {
        ...
        case 21 /* AddNamedPlugin */: {
          ...
          let {
            ...
            client,
            caller,
            callerType: pluginCallerType = _chunkC4OZ2LUZjs.CallerType.Other,
            methods = [],
            escrow = "",
            delegationType = 0n,
            lastValid = _chunkHFHM5QOFjs.MAX_UINT64,
            cooldown = 0n,
            useRounds = false,
          ...
          if (pluginCallerType === _chunkC4OZ2LUZjs.CallerType.Global) {
            caller = _algosdk.ALGORAND_ZERO_ADDRESS_STRING;
          } else if (pluginCallerType === _chunkC4OZ2LUZjs.CallerType.Admin) {
          ...
          if (methods.length > 0) {
            transformedMethods = methods.reduce(
              (acc, method) => {
                if (_chunkL3SAIW4Gjs.isPluginSDKReturn.call(void 0, method.name)) {
          ...
          const args = {
            ...
            approval,
            sourceLink,
            allowances: _chunkPIXALTBWjs.AllowancesToTuple.call(void 0, allowances)
          };
          if (name) {
            abiAction = { name, ...args };
        ...
        case 50 /* AddAllowances */: {
          ...
          abiAction = { escrow, allowances: _chunkPIXALTBWjs.AllowancesToTuple.call(void 0, allowances) };
        ...
        case 80 /* UpdateFields */: {
          ...
          switch (action.field) {
            ...
            case "aal": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, abiData, "AkitaAppList", this.client.appClient.appSpec.structs);
              break;
            }
            case "sal": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, abiData, "AkitaSocialAppList", this.client.appClient.appSpec.structs);
              break;
            }
            case "pal": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, { optin, revenueManager, update }, "PluginAppList", this.client.appClient.appSpec.structs);
              break;
            }
            case "oal": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, abiData, "OtherAppList", this.client.appClient.appSpec.structs);
              break;
            }
            case "wallet_fees": {
              ...
              const {
                ...
                referrerPercentage = _nullishCoalesce((currentFees == null ? void 0 : currentFees.referrerPercentage), () => ( 0n))
              } = action.value;
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, { createFee, referrerPercentage }, "WalletFees", this.client.appClient.appSpec.structs);
              break;
            }
            case "social_fees": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, abiData, "SocialFees", this.client.appClient.appSpec.structs);
              break;
            }
            case "staking_fees": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, abiData, "StakingFees", this.client.appClient.appSpec.structs);
              break;
            }
            case "subscription_fees": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, abiData, "SubscriptionFees", this.client.appClient.appSpec.structs);
              break;
            }
            case "nft_fees": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, abiData, "NftFees", this.client.appClient.appSpec.structs);
              break;
            }
            case "swap_fees": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, abiData, "SwapFees", this.client.appClient.appSpec.structs);
              break;
            }
            case "akita_assets": {
              ...
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, { akta, bones }, "AkitaAssets", this.client.appClient.appSpec.structs);
              break;
            }
            case "upgrade_app_ps":
            case "add_plugin_ps":
            ...
            case "update_fields_ps": {
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, action.value, "ProposalSettings", this.client.appClient.appSpec.structs);
              break;
            }
            case "revenue_splits": {
              data = _chunkUPNINHDSjs.encodeABIValue.call(void 0, SplitsToTuples(action.value), "((uint64,string),uint8,uint64)[]", this.client.appClient.appSpec.structs);
              break;
            }
            default:
      ...
      preppedActions.push([
        typedAction.type,
        _chunkUPNINHDSjs.encodeABIValue.call(void 0, abiAction, structType, this.typeClient.appClient.appSpec.structs)
      ]);
    }
  ...
  async setup(params = {}) {
    const sendParams = this.getSendParams(params);
    const { nickname = "Akita DAO", salt = _chunkUPNINHDSjs.randomByteArray.call(void 0, 32) } = params;
    _chunkUPNINHDSjs.assertByteArrayLength.call(void 0, salt, "salt", 32);
  ...
  async newProposal({
    ...
    const prepared = await _chunkC4OZ2LUZjs.prepareGroup.call(void 0, 
      await group.composer(),
      consolidateFees ? { consolidateFees: true } : {}
    );
    const { groupId, txIds, confirmedRound, returns } = await _chunkC4OZ2LUZjs.sendPrepared.call(void 0, 
      prepared,
  ...
  async proposalCost({ sender, signer, actions }) {
    const sendParams = this.getSendParams({
      ...
      signer: _nullishCoalesce(signer, () => ( _chunkHFHM5QOFjs.emptySigner))
    });
   ...
   */
  decodeProposalAction(actionType, actionData, useLegacyEscrowShape = false) {
    const structType = this.getActionStructType(actionType);
    const structs = this.typeClient.appClient.appSpec.structs;
    switch (actionType) {
      case 10 /* UpgradeApp */: {
        const decoded = _chunkUPNINHDSjs.decodeABIValue.call(void 0, actionData, structType, structs);
      ...
      case 70 /* NewEscrow */: {
        if (useLegacyEscrowShape) {
          try {
            const decoded2 = decodeLegacyProposalNewEscrow(actionData);
            return { type: 70 /* NewEscrow */, ...decoded2 };
          } catch (e2) {
          }
        }
        const decoded = _chunkUPNINHDSjs.decodeABIValue.call(void 0, actionData, structType, structs);
  ...
  async getProposal(proposalId) {
    ...
    const escrowActionV2Cutover = _chunkHFHM5QOFjs.getDaoEscrowActionV2Cutover.call(void 0, this.network);
    const useLegacyEscrowShape = usesLegacyEscrowActionShape(proposal.created, escrowActionV2Cutover == null ? void 0 : escrowActionV2Cutover.timestamp);
...
exports.SplitDistributionType = SplitDistributionType; exports.SplitsToTuples = SplitsToTuples; exports.ProposalActionEnum = ProposalActionEnum; exports.EMPTY_CID = EMPTY_CID; exports.DAOProposalVotesMBR = DAOProposalVotesMBR; exports.LEGACY_DAO_ACTION_STRUCTS = LEGACY_DAO_ACTION_STRUCTS; exports.decodeLegacyProposalNewEscrow = decodeLegacyProposalNewEscrow; exports.usesLegacyEscrowActionShape = usesLegacyEscrowActionShape; exports.DAO_ERROR_MESSAGES = DAO_ERROR_MESSAGES; exports.parseDaoErrorCode = parseDaoErrorCode; exports.translateDaoError = translateDaoError; exports.AkitaDaoSDK = AkitaDaoSDK;
//# sourceMappingURL=chunk-WS7EANGB.js.map