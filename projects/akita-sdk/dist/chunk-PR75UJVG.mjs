...
var translateRaffleError = makeErrorTranslator(RAFFLE_ERROR_MESSAGES);
...
var RaffleFactorySDK = class extends BaseSDK {
  ...
  async optIn({ sender, signer, asset }) {
    ...
    await this.client.newGroup().optIn({
      ...sendParams,
      args: { payment, asset },
      maxFee: microAlgo(257e3)
    }).opUp({
      ...sendParams,
      args: {},
      maxFee: microAlgo(2e3)
    }).send({
      ...sendParams,
...
//# sourceMappingURL=chunk-PR75UJVG.mjs.map