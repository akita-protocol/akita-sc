...
var _chunkURJA7W37js = require('./chunk-URJA7W37.js');
...
// src/dao/index.ts
var AkitaDaoSDK = (_class2 = class extends _chunkQRX6JALTjs.BaseSDK {
  
  __init5() {this._wallet = null}
  __init6() {this._walletInitPromise = null}
  
  constructor(params) {
    super({ factory: _chunkPFX6BSCEjs.AkitaDaoFactory, ...params }, _chunk4K2ZMC7Hjs.ENV_VAR_NAMES.DAO_APP_ID);_class2.prototype.__init5.call(this);_class2.prototype.__init6.call(this);;
  ...
  async _initializeWallet() {
    ...
    this._wallet = new (0, _chunkURJA7W37js.WalletSDK)({
      ...
      switch (typedAction.type) {
        ...
        case 21 /* AddNamedPlugin */: {
          ...
          let {
            ...
            client,
            caller,
            callerType: pluginCallerType = _chunkURJA7W37js.CallerType.Other,
            methods = [],
            escrow = "",
            delegationType = 0n,
            lastValid = _chunk4K2ZMC7Hjs.MAX_UINT64,
            cooldown = 0n,
            useRounds = false,
          ...
          if (pluginCallerType === _chunkURJA7W37js.CallerType.Global) {
            caller = _algosdk.ALGORAND_ZERO_ADDRESS_STRING;
          } else if (pluginCallerType === _chunkURJA7W37js.CallerType.Admin) {
  ...
  async newProposal({
    ...
    const prepared = await _chunkURJA7W37js.prepareGroup.call(void 0, 
      await group.composer(),
      consolidateFees ? { consolidateFees: true } : {}
    );
    const { groupId, txIds, confirmedRound, returns } = await _chunkURJA7W37js.sendPrepared.call(void 0, 
      prepared,
  ...
  async proposalCost({ sender, signer, actions }) {
    const sendParams = this.getSendParams({
      ...
      signer: _nullishCoalesce(signer, () => ( _chunk4K2ZMC7Hjs.emptySigner))
    });
...
//# sourceMappingURL=chunk-WXJI33BX.js.map