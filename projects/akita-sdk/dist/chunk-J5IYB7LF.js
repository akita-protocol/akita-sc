...
var AkitaDaoSDK = (_class2 = class extends _chunkT5TIVGPAjs.BaseSDK {
  
  __init5() {this._wallet = null}
  __init6() {this._walletInitPromise = null}
  
  constructor(params) {
    super({ factory: _chunkB2QFHBQDjs.AkitaDaoFactory, ...params }, _chunkPMAUR73Vjs.ENV_VAR_NAMES.DAO_APP_ID);_class2.prototype.__init5.call(this);_class2.prototype.__init6.call(this);;
  ...
  async _initializeWallet() {
    ...
    this._wallet = new (0, _chunkDP7H7ONIjs.WalletSDK)({
      ...
      switch (typedAction.type) {
        ...
        case 21 /* AddNamedPlugin */: {
          ...
          let {
            ...
            admin = false,
            delegationType = 0n,
            lastValid = _chunkPMAUR73Vjs.MAX_UINT64,
            cooldown = 0n,
            useRounds = false,
  ...
  async proposalCost({ sender, signer, actions }) {
    const sendParams = this.getSendParams({
      ...
      signer: _nullishCoalesce(signer, () => ( _chunkPMAUR73Vjs.emptySigner))
    });
...
//# sourceMappingURL=chunk-J5IYB7LF.js.map