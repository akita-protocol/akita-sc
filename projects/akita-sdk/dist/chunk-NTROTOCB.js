...
var AkitaDaoSDK = (_class2 = class extends _chunkA73G7K3Bjs.BaseSDK {
  ...
  async _initializeWallet() {
    ...
    this._wallet = new (0, _chunkXDEZUGPDjs.WalletSDK)({
      ...
      switch (typedAction.type) {
        ...
        case 21 /* AddNamedPlugin */: {
          ...
          let {
            ...
            client,
            caller,
            callerType: pluginCallerType = _chunkXDEZUGPDjs.CallerType.Other,
            methods = [],
            escrow = "",
            delegationType = 0n,
          ...
          if (pluginCallerType === _chunkXDEZUGPDjs.CallerType.Global) {
            caller = _algosdk.ALGORAND_ZERO_ADDRESS_STRING;
          } else if (pluginCallerType === _chunkXDEZUGPDjs.CallerType.Admin) {
  ...
  async newProposal({
    ...
    const prepared = await _chunkXDEZUGPDjs.prepareGroup.call(void 0, 
      await group.composer(),
      consolidateFees ? { consolidateFees: true } : {}
    );
    const { groupId, txIds, confirmedRound, returns } = await _chunkXDEZUGPDjs.sendPrepared.call(void 0, 
      prepared,
...
//# sourceMappingURL=chunk-NTROTOCB.js.map