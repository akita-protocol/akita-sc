...
var AkitaDaoSDK = (_class2 = class extends _chunkOPF2XL3Kjs.BaseSDK {
  ...
  async _initializeWallet() {
    ...
    this._wallet = new (0, _chunk7QSJ5YHVjs.WalletSDK)({
      ...
      switch (typedAction.type) {
        ...
        case 21 /* AddNamedPlugin */: {
          ...
          let {
            ...
            client,
            caller,
            callerType: pluginCallerType = _chunk7QSJ5YHVjs.CallerType.Other,
            methods = [],
            escrow = "",
            delegationType = 0n,
          ...
          if (pluginCallerType === _chunk7QSJ5YHVjs.CallerType.Global) {
            caller = _algosdk.ALGORAND_ZERO_ADDRESS_STRING;
          } else if (pluginCallerType === _chunk7QSJ5YHVjs.CallerType.Admin) {
  ...
  async newProposal({
    ...
    const prepared = await _chunk7QSJ5YHVjs.prepareGroup.call(void 0, 
      await group.composer(),
      consolidateFees ? { consolidateFees: true } : {}
    );
    const { groupId, txIds, confirmedRound, returns } = await _chunk7QSJ5YHVjs.sendPrepared.call(void 0, 
      prepared,
...
//# sourceMappingURL=chunk-3SKDWCEX.js.map