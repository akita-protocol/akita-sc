...
var SocialSDK = (_class9 = class _SocialSDK {
  ...
  constructor({
    ...
    readerAccount = _chunkI5AT2KOBjs.DEFAULT_READER,
    sendParams = _chunkI5AT2KOBjs.DEFAULT_SEND_PARAMS,
    ipfsUrl = ""
  }) {;_class9.prototype.__init29.call(this);_class9.prototype.__init30.call(this);_class9.prototype.__init31.call(this);
    this.algorand = algorand;
    this.network = _chunkI5AT2KOBjs.detectNetworkFromClient.call(void 0, algorand);
    this.daoAppId = _nullishCoalesce(daoAppId, () => ( _chunkI5AT2KOBjs.getAppIdFromEnv.call(void 0, _chunkI5AT2KOBjs.ENV_VAR_NAMES.DAO_APP_ID)));
    ...
    const resolvedSocialAppId = _chunkI5AT2KOBjs.resolveAppIdWithClient.call(void 0, algorand, socialFactoryParams.appId, _chunkI5AT2KOBjs.ENV_VAR_NAMES.SOCIAL_APP_ID, "SocialSDK.social");
    const resolvedGraphAppId = _chunkI5AT2KOBjs.resolveAppIdWithClient.call(void 0, algorand, graphFactoryParams.appId, _chunkI5AT2KOBjs.ENV_VAR_NAMES.SOCIAL_GRAPH_APP_ID, "SocialSDK.graph");
    const resolvedImpactAppId = _chunkI5AT2KOBjs.resolveAppIdWithClient.call(void 0, algorand, impactFactoryParams.appId, _chunkI5AT2KOBjs.ENV_VAR_NAMES.SOCIAL_IMPACT_APP_ID, "SocialSDK.impact");
    const resolvedModerationAppId = _chunkI5AT2KOBjs.resolveAppIdWithClient.call(void 0, algorand, moderationFactoryParams.appId, _chunkI5AT2KOBjs.ENV_VAR_NAMES.SOCIAL_MODERATION_APP_ID, "SocialSDK.moderation");
...
//# sourceMappingURL=chunk-REHPQ5MP.js.map