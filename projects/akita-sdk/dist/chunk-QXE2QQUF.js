...
var SubscriptionsSDK = (_class3 = class extends _chunkIDSXL6XOjs.BaseSDK {
  __init8() {this.serviceMapKeyGenerator = ({ address, id }) => `${address}${id}`}
  __init9() {this.services = new (0, _chunkVE4MYPMKjs.ValueMap)(this.serviceMapKeyGenerator)}
  constructor(params) {
    super({ factory: SubscriptionsFactory, ...params }, _chunkAG5OP4JOjs.ENV_VAR_NAMES.SUBSCRIPTIONS_APP_ID);_class3.prototype.__init8.call(this);_class3.prototype.__init9.call(this);;
  }
  /**
  ...
  async getServices() {
    ...
    this.services = new (0, _chunkVE4MYPMKjs.ValueMap)(
...
//# sourceMappingURL=chunk-QXE2QQUF.js.map