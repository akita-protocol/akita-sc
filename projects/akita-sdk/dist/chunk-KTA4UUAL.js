...
var BaseSDK = (_class = class {
  ...
  __init() {this.readerAccount = _chunkI5AT2KOBjs.DEFAULT_READER}
  __init2() {this.sendParams = _chunkI5AT2KOBjs.DEFAULT_SEND_PARAMS}
  ...
  constructor({ factoryParams, algorand, factory, readerAccount, sendParams }, envVarName) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);
    ...
    const resolvedAppId = _chunkI5AT2KOBjs.resolveAppIdWithClient.call(void 0, 
      algorand,
      factoryParams.appId,
...
//# sourceMappingURL=chunk-KTA4UUAL.js.map