...
var _chunkVVX2GLWYjs = require('./chunk-VVX2GLWY.js');
...
// src/dao/index.ts
var AkitaDaoSDK = (_class2 = class extends _chunkTEZ6RZMYjs.BaseSDK {
  
  __init5() {this._wallet = null}
  __init6() {this._walletInitPromise = null}
  
  constructor(params) {
    super({ factory: _chunkPFX6BSCEjs.AkitaDaoFactory, ...params }, _chunkPZXYH2VOjs.ENV_VAR_NAMES.DAO_APP_ID);_class2.prototype.__init5.call(this);_class2.prototype.__init6.call(this);;
  ...
  async _initializeWallet() {
    ...
    this._wallet = new (0, _chunkVVX2GLWYjs.WalletSDK)({
      ...
      switch (typedAction.type) {
        ...
        case 21 /* AddNamedPlugin */: {
          ...
          let {
            ...
            client,
            caller,
            callerType: pluginCallerType = _chunkVVX2GLWYjs.CallerType.Other,
            methods = [],
            escrow = "",
            delegationType = 0n,
            lastValid = _chunkPZXYH2VOjs.MAX_UINT64,
            cooldown = 0n,
            useRounds = false,
          ...
          if (pluginCallerType === _chunkVVX2GLWYjs.CallerType.Global) {
            caller = _algosdk.ALGORAND_ZERO_ADDRESS_STRING;
          } else if (pluginCallerType === _chunkVVX2GLWYjs.CallerType.Admin) {
  ...
  async newProposal({
    ...
    const prepared = await _chunkVVX2GLWYjs.prepareGroup.call(void 0, 
      await group.composer(),
      consolidateFees ? { consolidateFees: true } : {}
    );
    const { groupId, txIds, confirmedRound, returns } = await _chunkVVX2GLWYjs.sendPrepared.call(void 0, 
      prepared,
  ...
  async proposalCost({ sender, signer, actions }) {
    const sendParams = this.getSendParams({
      ...
      signer: _nullishCoalesce(signer, () => ( _chunkPZXYH2VOjs.emptySigner))
    });
...
//# sourceMappingURL=chunk-4WEX4S3D.js.map