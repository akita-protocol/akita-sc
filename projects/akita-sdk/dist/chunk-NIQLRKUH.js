...
// src/poll/factory.ts
var PollFactorySDK = class extends _chunkKTA4UUALjs.BaseSDK {
  constructor(params) {
    super({ factory: PollFactoryFactory, ...params }, _chunkI5AT2KOBjs.ENV_VAR_NAMES.POLL_FACTORY_APP_ID);
  }
  /**
  ...
  async deletePoll({ sender, signer, appId }) {
    ...
    composer.addAppCallMethodCall({
      ...sendParams,
      appId: this.appId,
      method: _abi.ABIMethod.fromSignature("deletePoll(uint64)void"),
      args: [appId],
...
// src/poll/index.ts
var PollSDK = class extends _chunkKTA4UUALjs.BaseSDK {
  constructor(params) {
...
//# sourceMappingURL=chunk-NIQLRKUH.js.map