...
function hashPair(a, b) {
  if (compareBytes(a, b) > 0) {
    return _sha2js.sha256.call(void 0, new Uint8Array([...b, ...a]));
  }
  return _sha2js.sha256.call(void 0, new Uint8Array([...a, ...b]));
}
...
function hashLeaf(encodedLeaf) {
  return _sha2js.sha256.call(void 0, _sha2js.sha256.call(void 0, encodedLeaf));
}
...
var MetaMerklesSDK = class extends _chunkIDSXL6XOjs.BaseSDK {
  constructor(params) {
    super({ factory: MetaMerklesFactory, ...params }, _chunkAG5OP4JOjs.ENV_VAR_NAMES.META_MERKLES_APP_ID);
  }
  // ========== Read Methods ==========
  /**
...
//# sourceMappingURL=chunk-SWZ6HWRQ.js.map