...
var AkitaDaoDeployableSDK = class extends _chunkYNEEL36Ujs.AkitaDaoSDK {
  constructor(params) {
    super(params);
  }
  async setup(params) {
    ...
    this.wallet = new (0, _chunkVJISSMPEjs.WalletSDK)({
...
exports.AkitaDaoDeployableSDK = AkitaDaoDeployableSDK; exports.AkitaDaoSDK = _chunkYNEEL36Ujs.AkitaDaoSDK;
