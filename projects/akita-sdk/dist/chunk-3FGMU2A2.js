...
var _chunkDCOQVO5Ijs = require('./chunk-DCOQVO5I.js');
...
// src/dao/index.ts
var AkitaDaoSDK = (_class2 = class extends _chunkIDSXL6XOjs.BaseSDK {
  
  __init5() {this._wallet = null}
  __init6() {this._walletInitPromise = null}
  
  constructor(params) {
    super({ factory: _chunkGNJHJVNXjs.AkitaDaoFactory, ...params }, _chunkAG5OP4JOjs.ENV_VAR_NAMES.DAO_APP_ID);_class2.prototype.__init5.call(this);_class2.prototype.__init6.call(this);;
  ...
  async _initializeWallet() {
    ...
    this._wallet = new (0, _chunkDCOQVO5Ijs.WalletSDK)({
      ...
      switch (typedAction.type) {
        ...
        case 21 /* AddNamedPlugin */: {
          ...
          let {
            ...
            client,
            caller,
            callerType: pluginCallerType = _chunkDCOQVO5Ijs.CallerType.Other,
            methods = [],
            escrow = "",
            delegationType = 0n,
            lastValid = _chunkAG5OP4JOjs.MAX_UINT64,
            cooldown = 0n,
            useRounds = false,
          ...
          if (pluginCallerType === _chunkDCOQVO5Ijs.CallerType.Global) {
            caller = _algosdk.ALGORAND_ZERO_ADDRESS_STRING;
          } else if (pluginCallerType === _chunkDCOQVO5Ijs.CallerType.Admin) {
  ...
  async newProposal({
    ...
    const prepared = await _chunkDCOQVO5Ijs.prepareGroup.call(void 0, 
      await group.composer(),
      consolidateFees ? { consolidateFees: true } : {}
    );
    const { groupId, txIds, confirmedRound, returns } = await _chunkDCOQVO5Ijs.sendPrepared.call(void 0, 
      prepared,
  ...
  async proposalCost({ sender, signer, actions }) {
    const sendParams = this.getSendParams({
      ...
      signer: _nullishCoalesce(signer, () => ( _chunkAG5OP4JOjs.emptySigner))
    });
  ...
  async getProposal(proposalId) {
    ...
    const escrowActionV2Cutover = _chunkAG5OP4JOjs.getDaoEscrowActionV2Cutover.call(void 0, this.network);
...
//# sourceMappingURL=chunk-3FGMU2A2.js.map