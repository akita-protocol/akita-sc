...
export declare class AkitaSocialGraphClient {
    ...
    readonly params: {
         ...
         * @returns The call params
         */
        mbr: (params: CallParams<AkitaSocialGraphArgs["obj"]["mbr(byte[],string,byte[])(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)"] | AkitaSocialGraphArgs["tuple"]["mbr(byte[],string,byte[])(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)"]> & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            signer?: (TransactionSigner | import("@algorandfoundation/algokit-utils/transact").AddressWithTransactionSigner) | undefined;
            appId: bigint;
    ...
    readonly send: {
        ...
        update: {
             ...
             */
            update: (params: CallParams<AkitaSocialGraphArgs["obj"]["update(string)void"] | AkitaSocialGraphArgs["tuple"]["update(string)void"]> & AppClientCompilationParams & SendParams & {
                onComplete?: OnApplicationComplete.UpdateApplication;
            }) => Promise<{
         ...
         * @returns The call result
         */
        mbr: (params: CallParams<AkitaSocialGraphArgs["obj"]["mbr(byte[],string,byte[])(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)"] | AkitaSocialGraphArgs["tuple"]["mbr(byte[],string,byte[])(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            return: (undefined | AkitaSocialGraphReturns["mbr(byte[],string,byte[])(uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64,uint64)"]);
            groupId: string | undefined;
            txIds: string[];
            returns?: ABIReturn[] | undefined | undefined;
            confirmations: import("@algorandfoundation/algokit-utils/algod-client").PendingTransactionResponse[];
    ...
    newGroup(composerConfig?: TransactionComposerConfig): AkitaSocialGraphComposer;
}
