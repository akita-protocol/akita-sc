...
export type StakingPoolTypes = {
     ...
     */
    methods: Record<'create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void' | 'create', {
 ...
 */
export type StakingPoolCreateCallParams = Expand<CallParams<StakingPoolArgs['obj']['create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void'] | StakingPoolArgs['tuple']['create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void']> & {
    method: 'create';
} & {
    onComplete?: OnApplicationComplete.NoOp;
} & CreateSchema> | Expand<CallParams<StakingPoolArgs['obj']['create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void'] | StakingPoolArgs['tuple']['create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void']> & {
...
export declare class StakingPoolFactory {
    ...
    readonly params: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<StakingPoolArgs["obj"]["create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void"] | StakingPoolArgs["tuple"]["create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void"]> & AppClientCompilationParams & CreateSchema & {
                onComplete?: OnApplicationComplete.NoOp;
            }) => Promise<{
    ...
    readonly send: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<StakingPoolArgs["obj"]["create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void"] | StakingPoolArgs["tuple"]["create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void"]> & AppClientCompilationParams & CreateSchema & SendParams & {
                onComplete?: OnApplicationComplete.NoOp;
            }) => Promise<{
                result: {
                    return: (undefined | StakingPoolReturns["create(string,uint8,address,(address,uint64),address,(address,string),uint64,bool,uint64,uint64,uint64,(string,uint64))void"]);
                    compiledApproval?: import("@algorandfoundation/algokit-utils").CompiledTeal | undefined;
                    compiledClear?: import("@algorandfoundation/algokit-utils").CompiledTeal | undefined;
                    groupId: string | undefined;
                    txIds: string[];
...
export declare class StakingPoolClient {
    ...
    readonly params: {
         ...
         * @returns The call params
         */
        updateAkitaDaoEscrow: (params: CallParams<StakingPoolArgs["obj"]["updateAkitaDAOEscrow((string,uint64))void"] | StakingPoolArgs["tuple"]["updateAkitaDAOEscrow((string,uint64))void"]> & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            signer?: (TransactionSigner | import("@algorandfoundation/algokit-utils/transact").AddressWithTransactionSigner) | undefined;
            appId: bigint;
    ...
    readonly send: {
        ...
        update: {
             ...
             */
            update: (params: CallParams<StakingPoolArgs["obj"]["update(string)void"] | StakingPoolArgs["tuple"]["update(string)void"]> & AppClientCompilationParams & SendParams & {
                onComplete?: OnApplicationComplete.UpdateApplication;
            }) => Promise<{
        ...
        delete: {
             ...
             */
            delete: (params: CallParams<StakingPoolArgs["obj"]["delete(address)void"] | StakingPoolArgs["tuple"]["delete(address)void"]> & SendParams & {
                onComplete?: OnApplicationComplete.DeleteApplication;
            }) => Promise<{
         ...
         * @returns The call result
         */
        updateAkitaDaoEscrow: (params: CallParams<StakingPoolArgs["obj"]["updateAkitaDAOEscrow((string,uint64))void"] | StakingPoolArgs["tuple"]["updateAkitaDAOEscrow((string,uint64))void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            return: (undefined | StakingPoolReturns["updateAkitaDAOEscrow((string,uint64))void"]);
            groupId: string | undefined;
            txIds: string[];
            returns?: ABIReturn[] | undefined | undefined;
            confirmations: import("@algorandfoundation/algokit-utils/algod-client").PendingTransactionResponse[];
    ...
    newGroup(composerConfig?: TransactionComposerConfig): StakingPoolComposer;
}
