...
export type SelfOptInPluginTypes = {
     ...
     */
    methods: Record<'optIn(uint64,bool,uint64[])void' | 'optIn', {
 ...
 */
export type SelfOptInPluginCreateCallParams = Expand<AppClientBareCallParams & {
    method?: never;
} & {
 ...
 */
export declare abstract class SelfOptInPluginParamsFactory {
    /**
 ...
 */
export declare class SelfOptInPluginFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): SelfOptInPluginClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<SelfOptInPluginClient>;
    /**
     ...
     */
    deploy(params?: SelfOptInPluginDeployParams): Promise<{
        result: {
        ...
        appClient: SelfOptInPluginClient;
    }>;
    /**
 ...
 */
export declare class SelfOptInPluginClient {
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<SelfOptInPluginClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<SelfOptInPluginClient>;
    ...
    readonly send: {
         ...
         */
        optIn: (params: CallParams<SelfOptInPluginArgs["obj"]["optIn(uint64,bool,uint64[])void"] | SelfOptInPluginArgs["tuple"]["optIn(uint64,bool,uint64[])void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            return: (undefined | SelfOptInPluginReturns["optIn(uint64,bool,uint64[])void"]);
            groupId: string | undefined;
            txIds: string[];
     ...
     */
    clone(params: CloneAppClientParams): SelfOptInPluginClient;
    /**
     * Methods to access state for the current SelfOptInPlugin app
     */
    state: {};
    newGroup(composerConfig?: TransactionComposerConfig): SelfOptInPluginComposer;
}
export type SelfOptInPluginComposer<TReturns extends [...any[]] = []> = {
     ...
     */
    simulate(): Promise<SelfOptInPluginComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<SelfOptInPluginComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<SelfOptInPluginComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    /**
