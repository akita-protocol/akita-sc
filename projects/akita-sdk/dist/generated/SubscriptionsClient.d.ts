 ...
 */
export declare function ServiceFromTuple(abiTuple: [number, bigint, bigint, bigint, bigint, bigint, string, string, string, Uint8Array, number, Uint8Array]): Service;
 ...
 */
export declare function SubscriptionInfoWithDetailsFromTuple(abiTuple: [string, bigint, bigint, bigint, bigint, bigint, bigint, number, string, string, string, Uint8Array, number, Uint8Array, bigint, bigint, bigint, string[]]): SubscriptionInfoWithDetails;
 ...
 */
export type SubscriptionsCreateCallParams = Expand<CallParams<SubscriptionsArgs['obj']['create(string,uint64,(string,uint64))void'] | SubscriptionsArgs['tuple']['create(string,uint64,(string,uint64))void']> & {
    method: 'create';
} & {
    onComplete?: OnApplicationComplete.NoOp;
} & CreateSchema> | Expand<CallParams<SubscriptionsArgs['obj']['create(string,uint64,(string,uint64))void'] | SubscriptionsArgs['tuple']['create(string,uint64,(string,uint64))void']> & {
...
export declare abstract class SubscriptionsParamsFactory {
    ...
    static get create(): {
         ...
         */
        create(params: CallParams<SubscriptionsArgs["obj"]["create(string,uint64,(string,uint64))void"] | SubscriptionsArgs["tuple"]["create(string,uint64,(string,uint64))void"]> & AppClientCompilationParams & {
            onComplete?: OnApplicationComplete.NoOp;
...
export declare class SubscriptionsFactory {
    ...
    readonly params: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<SubscriptionsArgs["obj"]["create(string,uint64,(string,uint64))void"] | SubscriptionsArgs["tuple"]["create(string,uint64,(string,uint64))void"]> & AppClientCompilationParams & CreateSchema & {
                onComplete?: OnApplicationComplete.NoOp;
            }) => Promise<{
    ...
    readonly send: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<SubscriptionsArgs["obj"]["create(string,uint64,(string,uint64))void"] | SubscriptionsArgs["tuple"]["create(string,uint64,(string,uint64))void"]> & AppClientCompilationParams & CreateSchema & SendParams & {
                onComplete?: OnApplicationComplete.NoOp;
            }) => Promise<{
                result: {
                    return: (undefined | SubscriptionsReturns["create(string,uint64,(string,uint64))void"]);
                    compiledApproval?: import("@algorandfoundation/algokit-utils").CompiledTeal | undefined;
                    compiledClear?: import("@algorandfoundation/algokit-utils").CompiledTeal | undefined;
                    groupId: string | undefined;
                    txIds: string[];
...
export declare class SubscriptionsClient {
    ...
    readonly params: {
         ...
         */
        newService: (params: CallParams<SubscriptionsArgs["obj"]["newService(pay,uint64,uint64,uint64,uint64,uint64,address,string,byte[36],uint8,byte[3])uint64"] | SubscriptionsArgs["tuple"]["newService(pay,uint64,uint64,uint64,uint64,uint64,address,string,byte[36],uint8,byte[3])uint64"]> & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            signer?: (TransactionSigner | import("@algorandfoundation/algokit-utils/transact").AddressWithTransactionSigner) | undefined;
            appId: bigint;
        ...
        * shutdownService permanently shuts down an service for a merchant
         ...
         * @returns The call params
         */
        getService: (params: CallParams<SubscriptionsArgs["obj"]["getService(address,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])"] | SubscriptionsArgs["tuple"]["getService(address,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])"]> & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            signer?: (TransactionSigner | import("@algorandfoundation/algokit-utils/transact").AddressWithTransactionSigner) | undefined;
            appId: bigint;
        ...
        * optIn opts this contract into `asset`. When this contract has a
         ...
         * @returns The call params
         */
        updateAkitaDaoEscrow: (params: CallParams<SubscriptionsArgs["obj"]["updateAkitaDAOEscrow((string,uint64))void"] | SubscriptionsArgs["tuple"]["updateAkitaDAOEscrow((string,uint64))void"]> & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            signer?: (TransactionSigner | import("@algorandfoundation/algokit-utils/transact").AddressWithTransactionSigner) | undefined;
            appId: bigint;
    ...
    readonly send: {
        ...
        update: {
             ...
             */
            update: (params: CallParams<SubscriptionsArgs["obj"]["update(string)void"] | SubscriptionsArgs["tuple"]["update(string)void"]> & AppClientCompilationParams & SendParams & {
                onComplete?: OnApplicationComplete.UpdateApplication;
            }) => Promise<{
         ...
         */
        newService: (params: CallParams<SubscriptionsArgs["obj"]["newService(pay,uint64,uint64,uint64,uint64,uint64,address,string,byte[36],uint8,byte[3])uint64"] | SubscriptionsArgs["tuple"]["newService(pay,uint64,uint64,uint64,uint64,uint64,address,string,byte[36],uint8,byte[3])uint64"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            return: (undefined | SubscriptionsReturns["newService(pay,uint64,uint64,uint64,uint64,uint64,address,string,byte[36],uint8,byte[3])uint64"]);
            groupId: string | undefined;
            txIds: string[];
        ...
        * shutdownService permanently shuts down an service for a merchant
        ...
        getService: (params: CallParams<SubscriptionsArgs["obj"]["getService(address,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])"] | SubscriptionsArgs["tuple"]["getService(address,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])"]> & SendParams & {
            ...
            return: (undefined | SubscriptionsReturns["getService(address,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])"]);
            groupId: string | undefined;
            txIds: string[];
            returns?: ABIReturn[] | undefined | undefined;
            confirmations: import("@algorandfoundation/algokit-utils/algod-client").PendingTransactionResponse[];
        ...
        getServicesByAddress: (params: CallParams<SubscriptionsArgs["obj"]["getServicesByAddress(address,uint64,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])[]"] | SubscriptionsArgs["tuple"]["getServicesByAddress(address,uint64,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])[]"]> & SendParams & {
            ...
            return: (undefined | SubscriptionsReturns["getServicesByAddress(address,uint64,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])[]"]);
            groupId: string | undefined;
            txIds: string[];
            returns?: ABIReturn[] | undefined | undefined;
            confirmations: import("@algorandfoundation/algokit-utils/algod-client").PendingTransactionResponse[];
         ...
         * @returns The call result
         */
        getSubscriptionWithDetails: (params: CallParams<SubscriptionsArgs["obj"]["getSubscriptionWithDetails((address,uint64))(address,uint64,uint64,uint64,uint64,uint64,uint64,uint8,address,string,string,byte[36],uint8,byte[3],uint64,uint64,uint64,address[])"] | SubscriptionsArgs["tuple"]["getSubscriptionWithDetails((address,uint64))(address,uint64,uint64,uint64,uint64,uint64,uint64,uint8,address,string,string,byte[36],uint8,byte[3],uint64,uint64,uint64,address[])"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            return: (undefined | SubscriptionsReturns["getSubscriptionWithDetails((address,uint64))(address,uint64,uint64,uint64,uint64,uint64,uint64,uint8,address,string,string,byte[36],uint8,byte[3],uint64,uint64,uint64,address[])"]);
            groupId: string | undefined;
            txIds: string[];
            returns?: ABIReturn[] | undefined | undefined;
            confirmations: import("@algorandfoundation/algokit-utils/algod-client").PendingTransactionResponse[];
        ...
        * optIn opts this contract into `asset`. When this contract has a
         ...
         * @returns The call result
         */
        updateAkitaDaoEscrow: (params: CallParams<SubscriptionsArgs["obj"]["updateAkitaDAOEscrow((string,uint64))void"] | SubscriptionsArgs["tuple"]["updateAkitaDAOEscrow((string,uint64))void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOp;
        }) => Promise<{
            return: (undefined | SubscriptionsReturns["updateAkitaDAOEscrow((string,uint64))void"]);
            groupId: string | undefined;
            txIds: string[];
            returns?: ABIReturn[] | undefined | undefined;
            confirmations: import("@algorandfoundation/algokit-utils/algod-client").PendingTransactionResponse[];
     ...
     * @returns The call result
     */
    getService(params: CallParams<SubscriptionsArgs['obj']['getService(address,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])'] | SubscriptionsArgs['tuple']['getService(address,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])']>): Promise<Service>;
    /**
     ...
     * @returns The call result
     */
    getServicesByAddress(params: CallParams<SubscriptionsArgs['obj']['getServicesByAddress(address,uint64,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])[]'] | SubscriptionsArgs['tuple']['getServicesByAddress(address,uint64,uint64)(uint8,uint64,uint64,uint64,uint64,uint64,address,string,string,byte[36],uint8,byte[3])[]']>): Promise<[number, bigint, bigint, bigint, bigint, bigint, string, string, string, Uint8Array<ArrayBufferLike>, number, Uint8Array<ArrayBufferLike>][]>;
    /**
     ...
     * @returns The call result
     */
    getSubscriptionWithDetails(params: CallParams<SubscriptionsArgs['obj']['getSubscriptionWithDetails((address,uint64))(address,uint64,uint64,uint64,uint64,uint64,uint64,uint8,address,string,string,byte[36],uint8,byte[3],uint64,uint64,uint64,address[])'] | SubscriptionsArgs['tuple']['getSubscriptionWithDetails((address,uint64))(address,uint64,uint64,uint64,uint64,uint64,uint64,uint8,address,string,string,byte[36],uint8,byte[3],uint64,uint64,uint64,address[])']>): Promise<SubscriptionInfoWithDetails>;
    /**
    ...
    newGroup(composerConfig?: TransactionComposerConfig): SubscriptionsComposer;
}
