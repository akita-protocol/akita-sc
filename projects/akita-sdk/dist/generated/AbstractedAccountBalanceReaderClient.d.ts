 ...
 */
export type AbstractedAccountBalanceReaderCreateCallParams = Expand<CallParams<AbstractedAccountBalanceReaderArgs['obj']['create(uint64)void'] | AbstractedAccountBalanceReaderArgs['tuple']['create(uint64)void']> & {
    method: 'create';
} & {
    onComplete?: OnApplicationComplete.NoOp;
} & CreateSchema> | Expand<CallParams<AbstractedAccountBalanceReaderArgs['obj']['create(uint64)void'] | AbstractedAccountBalanceReaderArgs['tuple']['create(uint64)void']> & {
 ...
 */
export declare abstract class AbstractedAccountBalanceReaderParamsFactory {
    /**
     * Gets available create ABI call param factories
     */
    static get create(): {
        _resolveByMethod<TParams extends AbstractedAccountBalanceReaderCreateCallParams & {
            method: string;
        }>(params: TParams): {
         ...
         */
        create(params: CallParams<AbstractedAccountBalanceReaderArgs["obj"]["create(uint64)void"] | AbstractedAccountBalanceReaderArgs["tuple"]["create(uint64)void"]> & AppClientCompilationParams & {
            onComplete?: OnApplicationComplete.NoOp;
 ...
 */
export declare class AbstractedAccountBalanceReaderFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): AbstractedAccountBalanceReaderClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<AbstractedAccountBalanceReaderClient>;
    /**
     ...
     */
    deploy(params?: AbstractedAccountBalanceReaderDeployParams): Promise<{
        result: {
        ...
        appClient: AbstractedAccountBalanceReaderClient;
    }>;
    /**
    ...
    readonly params: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<AbstractedAccountBalanceReaderArgs["obj"]["create(uint64)void"] | AbstractedAccountBalanceReaderArgs["tuple"]["create(uint64)void"]> & AppClientCompilationParams & CreateSchema & {
                onComplete?: OnApplicationComplete.NoOp;
            }) => Promise<{
    ...
    readonly send: {
        ...
        create: {
             ...
             */
            create: (params: CallParams<AbstractedAccountBalanceReaderArgs["obj"]["create(uint64)void"] | AbstractedAccountBalanceReaderArgs["tuple"]["create(uint64)void"]> & AppClientCompilationParams & CreateSchema & SendParams & {
                onComplete?: OnApplicationComplete.NoOp;
            }) => Promise<{
                result: {
                    return: (undefined | AbstractedAccountBalanceReaderReturns["create(uint64)void"]);
                    compiledApproval?: import("@algorandfoundation/algokit-utils").CompiledTeal | undefined;
                    compiledClear?: import("@algorandfoundation/algokit-utils").CompiledTeal | undefined;
                    groupId: string | undefined;
                    txIds: string[];
 ...
 */
export declare class AbstractedAccountBalanceReaderClient {
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<AbstractedAccountBalanceReaderClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<AbstractedAccountBalanceReaderClient>;
    ...
    readonly send: {
        ...
        * Get the balance of a set of assets at the given address, including any
        ...
        balance: (params: CallParams<AbstractedAccountBalanceReaderArgs["obj"]["balance(address,uint64[])uint64[]"] | AbstractedAccountBalanceReaderArgs["tuple"]["balance(address,uint64[])uint64[]"]> & SendParams & {
            ...
            return: (undefined | AbstractedAccountBalanceReaderReturns["balance(address,uint64[])uint64[]"]);
            groupId: string | undefined;
            txIds: string[];
     ...
     */
    clone(params: CloneAppClientParams): AbstractedAccountBalanceReaderClient;
    /**
    ...
    * Get the balance of a set of assets at the given address, including any
    ...
    newGroup(composerConfig?: TransactionComposerConfig): AbstractedAccountBalanceReaderComposer;
}
export type AbstractedAccountBalanceReaderComposer<TReturns extends [...any[]] = []> = {
    ...
    * Get the balance of a set of assets at the given address, including any
     ...
     */
    simulate(): Promise<AbstractedAccountBalanceReaderComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<AbstractedAccountBalanceReaderComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<AbstractedAccountBalanceReaderComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    /**
