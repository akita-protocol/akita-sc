...
export declare class MockAbstractedAccountFactoryClient {
    ...
    readonly send: {
        ...
        update: {
             ...
             */
            update: (params: CallParams<MockAbstractedAccountFactoryArgs["obj"]["update(string)void"] | MockAbstractedAccountFactoryArgs["tuple"]["update(string)void"]> & AppClientCompilationParams & SendParams & {
                onComplete?: OnApplicationComplete.UpdateApplication;
            }) => Promise<{
     ...
     */
    state: {};
    newGroup(composerConfig?: TransactionComposerConfig): MockAbstractedAccountFactoryComposer;
}
