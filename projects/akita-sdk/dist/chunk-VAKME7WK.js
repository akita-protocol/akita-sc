...
var _chunkBJ7XUICUjs = require('./chunk-BJ7XUICU.js');
...
// src/dao/index.ts
var AkitaDaoSDK = (_class2 = class extends _chunkA73G7K3Bjs.BaseSDK {
  
  __init5() {this._wallet = null}
  __init6() {this._walletInitPromise = null}
  
  constructor(params) {
    super({ factory: _chunkPFX6BSCEjs.AkitaDaoFactory, ...params }, _chunkYA4OODI3js.ENV_VAR_NAMES.DAO_APP_ID);_class2.prototype.__init5.call(this);_class2.prototype.__init6.call(this);;
  ...
  async _initializeWallet() {
    ...
    this._wallet = new (0, _chunkBJ7XUICUjs.WalletSDK)({
      ...
      switch (typedAction.type) {
        ...
        case 21 /* AddNamedPlugin */: {
          ...
          let {
            ...
            client,
            caller,
            callerType: pluginCallerType = _chunkBJ7XUICUjs.CallerType.Other,
            methods = [],
            escrow = "",
            delegationType = 0n,
            lastValid = _chunkYA4OODI3js.MAX_UINT64,
            cooldown = 0n,
            useRounds = false,
          ...
          if (pluginCallerType === _chunkBJ7XUICUjs.CallerType.Global) {
            caller = _algosdk.ALGORAND_ZERO_ADDRESS_STRING;
          } else if (pluginCallerType === _chunkBJ7XUICUjs.CallerType.Admin) {
  ...
  async newProposal({
    ...
    const prepared = await _chunkBJ7XUICUjs.prepareGroup.call(void 0, 
      await group.composer(),
      consolidateFees ? { consolidateFees: true } : {}
    );
    const { groupId, txIds, confirmedRound, returns } = await _chunkBJ7XUICUjs.sendPrepared.call(void 0, 
      prepared,
  ...
  async proposalCost({ sender, signer, actions }) {
    const sendParams = this.getSendParams({
      ...
      signer: _nullishCoalesce(signer, () => ( _chunkYA4OODI3js.emptySigner))
    });
...
//# sourceMappingURL=chunk-VAKME7WK.js.map