...
var AkitaDaoSDK = class extends BaseSDK {
        ...
        case 80 /* UpdateFields */: {
          ...
          switch (action.field) {
            ...
            case "wallet_fees": {
              ...
              data = encodeABIValue({ createFee }, "WalletFees", this.client.appClient.appSpec.structs);
              break;
            }
            case "social_fees": {
  ...
  async setup(params = {}) {
    ...
    group.opUp({ args: {}, note: "1", maxFee: microAlgo(1000n) });
    group.opUp({ args: {}, note: "2", maxFee: microAlgo(1000n) });
  ...
  async newProposal({
    ...
    for (let i = 0; i < actions.length; i++) {
      group.opUp({ args: {}, note: `${i}`, maxFee: microAlgo(257000n) });
    }
...
//# sourceMappingURL=chunk-Q3APAFVB.mjs.map