...
var BaseSDK = (_class = class {
  ...
  __init() {this.readerAccount = _chunkAG5OP4JOjs.DEFAULT_READER}
  ...
  constructor({ factoryParams, algorand, factory, readerAccount, sendParams }, envVarName) {;_class.prototype.__init.call(this);
    ...
    const resolvedAppId = _chunkAG5OP4JOjs.resolveAppIdWithClient.call(void 0, 
      algorand,
      factoryParams.appId,
    ...
    this.sendParams = { ..._nullishCoalesce(sendParams, () => ( _chunkAG5OP4JOjs.DEFAULT_SEND_PARAMS)) };
...
//# sourceMappingURL=chunk-IDSXL6XO.js.map