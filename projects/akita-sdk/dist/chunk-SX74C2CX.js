...
var AkitaDaoSDK = (_class2 = class extends _chunkTEZ6RZMYjs.BaseSDK {
  ...
  async _initializeWallet() {
    ...
    this._wallet = new (0, _chunkWT3ZDSI3js.WalletSDK)({
      ...
      switch (typedAction.type) {
        ...
        case 21 /* AddNamedPlugin */: {
          ...
          let {
            ...
            client,
            caller,
            callerType: pluginCallerType = _chunkWT3ZDSI3js.CallerType.Other,
            methods = [],
            escrow = "",
            delegationType = 0n,
          ...
          if (pluginCallerType === _chunkWT3ZDSI3js.CallerType.Global) {
            caller = _algosdk.ALGORAND_ZERO_ADDRESS_STRING;
          } else if (pluginCallerType === _chunkWT3ZDSI3js.CallerType.Admin) {
  ...
  async newProposal({
    ...
    const prepared = await _chunkWT3ZDSI3js.prepareGroup.call(void 0, 
      await group.composer(),
      consolidateFees ? { consolidateFees: true } : {}
    );
    const { groupId, txIds, confirmedRound, returns } = await _chunkWT3ZDSI3js.sendPrepared.call(void 0, 
      prepared,
...
//# sourceMappingURL=chunk-SX74C2CX.js.map