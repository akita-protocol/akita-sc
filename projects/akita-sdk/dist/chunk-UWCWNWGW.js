...
var BaseSDK = (_class = class {
  ...
  __init() {this.readerAccount = _chunkJ3FKGT5Ejs.DEFAULT_READER}
  __init2() {this.sendParams = _chunkJ3FKGT5Ejs.DEFAULT_SEND_PARAMS}
  ...
  constructor({ factoryParams, algorand, factory, readerAccount, sendParams }, envVarName) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);
    ...
    const resolvedAppId = _chunkJ3FKGT5Ejs.resolveAppIdWithClient.call(void 0, 
      algorand,
      factoryParams.appId,
...
//# sourceMappingURL=chunk-UWCWNWGW.js.map