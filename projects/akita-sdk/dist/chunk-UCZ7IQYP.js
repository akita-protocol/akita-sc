...
var _chunkHU54ROD2js = require('./chunk-HU54ROD2.js');
...
// src/auction/factory.ts
var AuctionFactorySDK = class extends _chunkJSRHAYKEjs.BaseSDK {
  constructor(params) {
    super({ factory: AuctionFactoryFactory, ...params }, _chunkHXGCVEIGjs.ENV_VAR_NAMES.AUCTION_FACTORY_APP_ID);
  }
  /**
  ...
  async newAuction({
    ...
    if (isPrizeBox) {
      ...
      const prizeBoxSDK = new (0, _chunkHU54ROD2js.PrizeBoxFactorySDK)({ algorand: this.algorand, factoryParams: {} }).get({ appId: BigInt(prizeBoxId) });
...
// src/auction/index.ts
var AuctionSDK = class extends _chunkJSRHAYKEjs.BaseSDK {
  constructor(params) {
...
//# sourceMappingURL=chunk-UCZ7IQYP.js.map