...
export type NewServiceArgs =Omit<ContractArgs['newService(pay,uint64,uint64,uint64,uint64,uint64,address,string,byte[36],uint8,byte[3])uint64'], 'payment' | 'highlightColor'>
  & {
