...
export function Arc4ImpactMetaValueFromTuple(abiTuple: [bigint, bigint, bigint, bigint, bigint]) {
  const abiStructType = ABIStructType.fromStruct('arc4ImpactMetaValue', APP_SPEC.structs)
  return getStructValueFromTupleValue(abiStructType, abiTuple) as Arc4ImpactMetaValue
}
...
export class AkitaSocialImpactClient {
  ...
  readonly params = {
     ...
     */
    cacheMeta: (params: CallParams<AkitaSocialImpactArgs['obj']['cacheMeta(uint64,uint64,uint64)uint64'] | AkitaSocialImpactArgs['tuple']['cacheMeta(uint64,uint64,uint64)uint64']> & { onComplete?: OnApplicationComplete.NoOp }) => {
     ...
     * @returns The call params
     */
    getMeta: (params: CallParams<AkitaSocialImpactArgs['obj']['getMeta(address)(uint64,uint64,uint64,uint64,uint64,uint64,bool,uint64,uint64)'] | AkitaSocialImpactArgs['tuple']['getMeta(address)(uint64,uint64,uint64,uint64,uint64,uint64,bool,uint64,uint64)']> & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
     ...
     */
    cacheMeta: async (params: CallParams<AkitaSocialImpactArgs['obj']['cacheMeta(uint64,uint64,uint64)uint64'] | AkitaSocialImpactArgs['tuple']['cacheMeta(uint64,uint64,uint64)uint64']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
     ...
     * @returns The call result
     */
    getMeta: async (params: CallParams<AkitaSocialImpactArgs['obj']['getMeta(address)(uint64,uint64,uint64,uint64,uint64,uint64,bool,uint64,uint64)'] | AkitaSocialImpactArgs['tuple']['getMeta(address)(uint64,uint64,uint64,uint64,uint64,uint64,bool,uint64,uint64)']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
