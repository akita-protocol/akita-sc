...
export const APP_SPEC: Arc56Contract = {"name":"MockAbstractedAccountFactory","structs":{},"methods":[{"name":"update","args":[{"type":"string","name":"newVersion"}],"returns":{"type":"void"},"actions":{"create":[],"call":["UpdateApplication"]},"readonly":false,"events":[],"recommendations":{}},{"name":"ping","args":[],"returns":{"type":"uint64"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":0},"local":{"ints":0,"bytes":0}},"keys":{"global":{},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":["NoOp"],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[79],"errorMessage":"invalid array length header"},{"pc":[86],"errorMessage":"invalid number of bytes for arc4.dynamic_array<arc4.uint8>"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"source":{"approval":"","clear":"I3ByYWdtYSB2ZXJzaW9uIDExCiNwcmFnbWEgdHlwZXRyYWNrIGZhbHNlCgovLyBAYWxnb3JhbmRmb3VuZGF0aW9uL2FsZ29yYW5kLXR5cGVzY3JpcHQvYmFzZS1jb250cmFjdC5kLnRzOjpCYXNlQ29udHJhY3QuY2xlYXJTdGF0ZVByb2dyYW0oKSAtPiB1aW50NjQ6Cm1haW46CiAgICBwdXNoaW50IDEKICAgIHJldHVybgo="},"byteCode":{"approval":"CzEbQQA7ggIE6pGA3QQdXFYbNhoAjgIAGgABADEZFDEYEESADBUffHUAAAAAAAAQkrCBAUMxGYEEEjEYEERCAAgxGRQxGBQQQzYaAUmBAFmBAghMFRJEgQFD","clear":"C4EBQw=="},"events":[],"templateVariables":{}} as unknown as Arc56Contract
...
export class MockAbstractedAccountFactoryClient {
  ...
  readonly params = {
    ...
    update: {
       ...
       */
      update: (params: CallParams<MockAbstractedAccountFactoryArgs['obj']['update(string)void'] | MockAbstractedAccountFactoryArgs['tuple']['update(string)void']> & AppClientCompilationParams & { onComplete?: OnApplicationComplete.UpdateApplication }) => {
     ...
     */
    ping: (params: CallParams<MockAbstractedAccountFactoryArgs['obj']['ping()uint64'] | MockAbstractedAccountFactoryArgs['tuple']['ping()uint64']> & { onComplete?: OnApplicationComplete.NoOp } = {args: []}) => {
  ...
  readonly send = {
    ...
    update: {
       ...
       */
      update: async (params: CallParams<MockAbstractedAccountFactoryArgs['obj']['update(string)void'] | MockAbstractedAccountFactoryArgs['tuple']['update(string)void']> & AppClientCompilationParams & SendParams & { onComplete?: OnApplicationComplete.UpdateApplication }) => {
     ...
     */
    ping: async (params: CallParams<MockAbstractedAccountFactoryArgs['obj']['ping()uint64'] | MockAbstractedAccountFactoryArgs['tuple']['ping()uint64']> & SendParams & { onComplete?: OnApplicationComplete.NoOp } = {args: []}) => {
  ...
  public newGroup(composerConfig?: TransactionComposerConfig): MockAbstractedAccountFactoryComposer {
    const client = this
    ...
    return {
       ...
       */
      ping(params: CallParams<MockAbstractedAccountFactoryArgs['obj']['ping()uint64'] | MockAbstractedAccountFactoryArgs['tuple']['ping()uint64']> & { onComplete?: OnApplicationComplete.NoOp }) {
...
export type MockAbstractedAccountFactoryComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<MockAbstractedAccountFactoryComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<MockAbstractedAccountFactoryComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<MockAbstractedAccountFactoryComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
   * Sends the transaction group to the network and returns the results
   */
  send(params?: SendParams): Promise<MockAbstractedAccountFactoryComposerResults<TReturns>>
}
export type MockAbstractedAccountFactoryComposerResults<TReturns extends [...any[]]> = Expand<SendTransactionComposerResults & {
  returns: TReturns
}>
