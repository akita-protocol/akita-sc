...
export type PaySiloPluginCreateCallParams =
  | Expand<CallParams<PaySiloPluginArgs['obj']['create(address)void'] | PaySiloPluginArgs['tuple']['create(address)void']> & {method: 'create'} & { onComplete?: OnApplicationComplete.NoOp } & CreateSchema>
  | Expand<CallParams<PaySiloPluginArgs['obj']['create(address)void'] | PaySiloPluginArgs['tuple']['create(address)void']> & {method: 'create(address)void'} & { onComplete?: OnApplicationComplete.NoOp } & CreateSchema>
/**
...
export abstract class PaySiloPluginParamsFactory {
  ...
  static get create() {
    return {
       ...
       */
      create(params: CallParams<PaySiloPluginArgs['obj']['create(address)void'] | PaySiloPluginArgs['tuple']['create(address)void']> & AppClientCompilationParams & { onComplete?: OnApplicationComplete.NoOp }): AppClientMethodCallParams & AppClientCompilationParams & { onComplete?: OnApplicationComplete.NoOp } {
        return {
          ...params,
...
export class PaySiloPluginFactory {
  ...
  readonly params = {
    ...
    create: {
       ...
       */
      create: (params: CallParams<PaySiloPluginArgs['obj']['create(address)void'] | PaySiloPluginArgs['tuple']['create(address)void']> & AppClientCompilationParams & CreateSchema & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
    ...
    create: {
       ...
       */
      create: async (params: CallParams<PaySiloPluginArgs['obj']['create(address)void'] | PaySiloPluginArgs['tuple']['create(address)void']> & AppClientCompilationParams & CreateSchema & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
...
export class PaySiloPluginClient {
  ...
  readonly params = {
     ...
     */
    pay: (params: CallParams<PaySiloPluginArgs['obj']['pay(uint64,bool,(uint64,uint64)[])void'] | PaySiloPluginArgs['tuple']['pay(uint64,bool,(uint64,uint64)[])void']> & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
     ...
     */
    pay: async (params: CallParams<PaySiloPluginArgs['obj']['pay(uint64,bool,(uint64,uint64)[])void'] | PaySiloPluginArgs['tuple']['pay(uint64,bool,(uint64,uint64)[])void']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  public newGroup(composerConfig?: TransactionComposerConfig): PaySiloPluginComposer {
    const client = this
...
export type PaySiloPluginComposerResults<TReturns extends [...any[]]> = Expand<SendTransactionComposerResults & {
  returns: TReturns
}>
