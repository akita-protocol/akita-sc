...
export class PollFactoryClient {
  ...
  readonly params = {
     ...
     * @returns The call params
     */
    deletePoll: (params: CallParams<PollFactoryArgs['obj']['deletePoll(uint64)void'] | PollFactoryArgs['tuple']['deletePoll(uint64)void']> & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
     ...
     * @returns The call result
     */
    deletePoll: async (params: CallParams<PollFactoryArgs['obj']['deletePoll(uint64)void'] | PollFactoryArgs['tuple']['deletePoll(uint64)void']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
