...
export class PayPluginClient {
  ...
  readonly params = {
     ...
     */
    pay: (params: CallParams<PayPluginArgs['obj']['pay(uint64,bool,(address,uint64,uint64)[])void'] | PayPluginArgs['tuple']['pay(uint64,bool,(address,uint64,uint64)[])void']> & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
     ...
     */
    pay: async (params: CallParams<PayPluginArgs['obj']['pay(uint64,bool,(address,uint64,uint64)[])void'] | PayPluginArgs['tuple']['pay(uint64,bool,(address,uint64,uint64)[])void']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  public newGroup(composerConfig?: TransactionComposerConfig): PayPluginComposer {
    const client = this
...
export type PayPluginComposerResults<TReturns extends [...any[]]> = Expand<SendTransactionComposerResults & {
  returns: TReturns
}>
