...
export type PollCreateCallParams =
  | Expand<CallParams<PollArgs['obj']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void'] | PollArgs['tuple']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void']> & {method: 'create'} & { onComplete?: OnApplicationComplete.NoOp } & CreateSchema>
...
export class PollFactory {
  ...
  readonly params = {
    ...
    create: {
       ...
       */
      create: (params: CallParams<PollArgs['obj']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void'] | PollArgs['tuple']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void']> & AppClientCompilationParams & CreateSchema & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
    ...
    create: {
       ...
       */
      create: async (params: CallParams<PollArgs['obj']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void'] | PollArgs['tuple']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void']> & AppClientCompilationParams & CreateSchema & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
...
export class PollClient {
  ...
  readonly params = {
    ...
    delete: {
       ...
       */
      deleteApplication: (params: CallParams<PollArgs['obj']['deleteApplication()void'] | PollArgs['tuple']['deleteApplication()void']> & { onComplete?: OnApplicationComplete.DeleteApplication } = {args: []}) => {
  ...
  readonly send = {
    ...
    delete: {
       ...
       */
      deleteApplication: async (params: CallParams<PollArgs['obj']['deleteApplication()void'] | PollArgs['tuple']['deleteApplication()void']> & SendParams & { onComplete?: OnApplicationComplete.DeleteApplication } = {args: []}) => {
