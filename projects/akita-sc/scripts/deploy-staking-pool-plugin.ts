...
runScript(async () => {
  ...
  await recordPluginDeployment(options.network, 'stakingPoolPlugin', plugin.appId, options.version)
...
${pluginDeploymentInstructions(options.network, 'stakingPoolPlugin', plugin.appId, options.version)}
`)
})
