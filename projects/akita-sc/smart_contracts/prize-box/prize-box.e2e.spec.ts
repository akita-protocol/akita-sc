...
describe('Prize Box SDK', () => {
    ...
    let recipient: Address & TransactionSignerAccount
    ...
    beforeAll(async () => {
        ...
        testAssetId = BigInt(assetCreate1.confirmation.assetId!)
        ...
        testAssetId2 = BigInt(assetCreate2.confirmation.assetId!)
