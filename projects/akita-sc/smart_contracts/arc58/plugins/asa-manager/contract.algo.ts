import { Application, Asset, Global, gtxn, itxn, loggedAssert, uint64 } from "@algorandfoundation/algorand-typescript";
...
export class AsaManagerPlugin extends Contract {
