...
import { newWallet, RewardsPluginSDK, WalletSDK, CallerType } from 'akita-sdk/wallet';
...
describe('Rewards plugin contract', () => {
  ...
  beforeAll(async () => {
    ...
    await wallet.addPlugin({ client: rewardsPluginSdk, callerType: CallerType.Global });
  });
