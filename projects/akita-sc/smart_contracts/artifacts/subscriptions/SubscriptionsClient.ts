...
export class SubscriptionsClient {
  ...
  readonly params = {
     ...
     * @returns The call params
     */
    setServiceDescription: (params: CallParams<SubscriptionsArgs['obj']['setServiceDescription(uint64,byte[])void'] | SubscriptionsArgs['tuple']['setServiceDescription(uint64,byte[])void']> & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
     ...
     * @returns The call result
     */
    setServiceDescription: async (params: CallParams<SubscriptionsArgs['obj']['setServiceDescription(uint64,byte[])void'] | SubscriptionsArgs['tuple']['setServiceDescription(uint64,byte[])void']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
