...
export class AkitaDaoTypesClient {
  ...
  readonly params = {
     ...
     * @returns The call params
     */
    proposalNewEscrowShape: (params: CallParams<AkitaDaoTypesArgs['obj']['proposalNewEscrowShape((string))(string)'] | AkitaDaoTypesArgs['tuple']['proposalNewEscrowShape((string))(string)']> & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
     ...
     * @returns The call result
     */
    proposalNewEscrowShape: async (params: CallParams<AkitaDaoTypesArgs['obj']['proposalNewEscrowShape((string))(string)'] | AkitaDaoTypesArgs['tuple']['proposalNewEscrowShape((string))(string)']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
