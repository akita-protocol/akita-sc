...
export class DaoStubClient {
  ...
  readonly params = {
     ...
     */
    isValidUpgrade: (params: CallParams<DaoStubArgs['obj']['isValidUpgrade(byte[32],uint64)bool'] | DaoStubArgs['tuple']['isValidUpgrade(byte[32],uint64)bool']> & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  readonly send = {
     ...
     */
    isValidUpgrade: async (params: CallParams<DaoStubArgs['obj']['isValidUpgrade(byte[32],uint64)bool'] | DaoStubArgs['tuple']['isValidUpgrade(byte[32],uint64)bool']> & SendParams & { onComplete?: OnApplicationComplete.NoOp }) => {
  ...
  public newGroup(composerConfig?: TransactionComposerConfig): DaoStubComposer {
    const client = this
...
export type DaoStubComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<DaoStubComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<DaoStubComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<DaoStubComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
